...
the real-corpus false positives — full postmortem in [rung3/followups.md](archive/rounds/followups.md)):
...
> different pieces ([rung3/round2.md](archive/rounds/round2.md)).
