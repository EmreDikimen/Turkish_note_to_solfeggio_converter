...
Moved to **[deploy-ops.md](deploy-ops.md)** (2026-08-07, the 400-line cap): the local commands, what
each check proves, the container build and the `gcloud run deploy` line.
