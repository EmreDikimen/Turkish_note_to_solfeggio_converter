# W0–W3 — opencv.js parity, the decode module, and the browser-vs-Python verdict

purpose: the record of the first four MVP rungs — what each proved, and the hypothesis that died between W2 and W3
audience: agents working the MVP track
updated: 2026-08-07

> Split out of [rungs.md](rungs.md) on 2026-08-07 at the 400-line cap. That page now holds the
> **slicer** rungs (W4–W7); this one holds the four that came before. The ladder itself, with
> current state, is [README.md](README.md); next action is [../STATUS.md](../STATUS.md).
