...
Two Step-4.0 metrics report ALONGSIDE the recall headline (docs/archive/rounds/ship-criteria.md):
...
def main() -> int:
    ...
    exact = 0
    shown = 0
    # Arc-triggered false-\tup3 metric (pre-registered, docs/archive/rounds/ship-criteria.md): the damaging
